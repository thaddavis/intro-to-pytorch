        ...
        for m in range(layer_size):
            ...
            if n == 0:
                ax.annotate(f'Input {m+1}', (n*h_spacing + left, layer_top - m*v_spacing), 
                            textcoords="offset points", xytext=(-25,25*v_spacing), ha='center', fontsize=12, color='blue')
                ...
                ax.annotate(f'Layer {n}-{m+1}', (n*h_spacing + left, layer_top - m*v_spacing), 
                            textcoords="offset points", xytext=(0,25*v_spacing), ha='center', fontsize=12, color='blue')
